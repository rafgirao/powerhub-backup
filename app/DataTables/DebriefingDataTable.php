...
class DebriefingDataTable extends DataTable
{
    /**
    ...
    {
        return view('debriefings.buttons',[
            'project'=> $data,
        ]);
    }
    ...
    {
        return Project::where('id', ">", 0)->where('account',session()->get('account')->id)->orderBy('updated_at', 'DESC');
    }
...
//                'pagingType' => 'full',
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::computed('start_at', 'Início'),
            Column::computed('end_at', 'Fim'),
