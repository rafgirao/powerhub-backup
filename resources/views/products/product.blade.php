    ...
    @component('layouts.headers.auth')
        @component('layouts.headers.breadcrumbs')
            @slot('title')
                {{--                {{ __('Produtos') }}--}}
            @endslot
            <li class="breadcrumb-item"><a href="{{ route('products') }}">{{ __('Produtos') }}</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{ __('Todos os Produtos') }}</li>
        @endcomponent
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Todos os Produtos</h3>
