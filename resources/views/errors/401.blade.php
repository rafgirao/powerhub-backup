            ...
            <div class="header-body text-center mb-7">
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                        <h1 class="text-white">{{ __('Erro 401') }}</h1>
                        <p class="text-lead text-white">{{ __('Oppps... Parece que você não tem acesso a esse recurso.') }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card card-profile bg-secondary mt-5">
                    ...
                    <div class="card-body pt-7 px-5">
                        <div class="text-center mb-4">
                            <h3>{{ 'Mas você ainda pode testar outros recursos...' }}</h3>
                        </div>
