            ...
            <div class="col">
                <div class="card-wrapper">
                    ...
                    <div class="card">
                        ...
                        <!-- Card body -->
                        <div class="card-body">
                            <form name="projects" action="{{route('projects.update', $project->id)}}" method="post" autocomplete="off">
                                @csrf
                                @method('PUT')
                                            ...
                                            <div class="card-body">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="projectTimeline" class="form-control" placeholder="Informe as datas chave do seu lançamento" rows="4" aria-label="Informe as Datas / Timeline do Lançamento">{{ old('projectTimeline') ?? $project->cp_timeline}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="projectOpportunities" class="form-control" placeholder="Descreva as oportunidades que o mercado tem no momento do lançamento" aria-label="Oportunidades do Mercado">{{ old('projectOpportunities') ?? $project->cp_opportunities}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="projectAvatarInfo" class="form-control" placeholder="Descreva aqui as Dores e os Sonhos do Seu Avatar" aria-label="Avatar: Dores e Sonhos">{{ old('projectAvatarInfo') ?? $project->cp_avatar_pains_dreams}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="projectCopy" class="form-control" placeholder="Descreva os 3 Pilares da Copy do seu Lançamento (CIM)" aria-label="Copy do Lançamento">{{ old('projectCopy') ?? $project->cp_copy}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <input name="projectEventName" class="form-control" placeholder="Informe nome para o seu evento" type="text" value="{{ old('projectEventName') ?? $project->cp_event_name}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="projectPromises" class="form-control" placeholder="Informe 20 vantagens claras e tangíveis em participar do lançamento" aria-label="Promessas do Lançamento">{{ old('projectPromises') ?? $project->cp_event_promises}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="avatarObjections" class="form-control" placeholder="Escreva uma lista de possíveis objeções do seu avatar" aria-label="Objeções do Avatar">{{ old('avatarObjections') ?? $project->cp_avatar_objections}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="avatarTrapsMyths" class="form-control" placeholder="Liste ao menos 8 armadilhas bem clássicas do seu nicho" aria-label="Armadilhas e mitos do avatar">{{ old('avatarTrapsMyths') ?? $project->cp_avatar_traps_myths}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="projectDesign" class="form-control" placeholder="Descreva a linha gráfica do lançamento" aria-label="Linha Gráfica do Lançamento">{{ old('projectDesign') ?? $project->cp_design_launch_line}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="productQualities" class="form-control" placeholder="Descreva a linha gráfica do lançamento" aria-label="Linha Gráfica do Lançamento">{{ old('productQualities') ?? $project->cp_product_qualities}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        {{--                                                        </button>--}}
                                                        <div class="input-group input-group-merge">
                                                            <input name="productEfficiency" class="form-control" placeholder="Descreva a Eficiência do seu Produto" type="text" value="{{ old('productEfficiency') ?? $project->cp_product_efficiency}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        {{--                                                        </button>--}}
                                                        <div class="input-group input-group-merge">
                                                            <input name="productUnique" class="form-control" placeholder="Descreva se seu produto é único" type="text" value="{{ old('productUnique') ?? $project->cp_product_unique}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="productSteps" class="form-control" placeholder="Descreva os passos que o método usa para gerar transformação" aria-label="Quais são os passos que o método usa para gerar transformação?">{{ old('productSteps') ?? $project->cp_product_steps}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="productWarranty" class="form-control" placeholder="Descreva como é a garantia do seu produto" aria-label="A Garantia é No Brainner?">{{ old('productWarranty') ?? $project->cp_product_warranty}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="offer_Unique" class="form-control" placeholder="Descreva se a oferta é irresistível" aria-label="A oferta é realmente irresistível?">{{ old('offer_Unique') ?? $project->cp_offer_unique}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="commonEnemy" class="form-control" placeholder="Descreva como é a garantia do seu produto" aria-label="Qual é o grande vilão?">{{ old('commonEnemy') ?? $project->cp_common_enemy}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="productWho" class="form-control" placeholder="Descreva para quem é o Programa" aria-label="Para quem é o Programa</">{{ old('productWho') ?? $project->cp_who}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="productRequirements" class="form-control" placeholder="Descreva para quem é o Programa" aria-label="Para quem é o Programa">{{ old('productRequirements') ?? $project->cp_requirements}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge">
                                                                    <input name="nicheEvaluation" id="nicheEvaluation" class="form-control nicheEvaluation" placeholder="Informe a Nota do Nicho" type="number" step="0.01" value="{{ old('nicheEvaluation') ?? $project->cp_niche}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge">
                                                                    <input name="productEvaluation" id="productEvaluation" class="form-control productEvaluation" placeholder="Informe a Nota do Produto" type="number" step="0.01" min="0" max="10.00" value="{{ old('productEvaluation') ?? $project->cp_product}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge">
                                                                    <input name="offerEvaluation" id="offerEvaluation" class="form-control offerEvaluation" placeholder="Informe a Nota da Oferta" type="number" step="0.01" min="0" max="10.00" value="{{ old('offerEvaluation') ?? $project->cp_offer}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge">
                                                                    <input name="npoEvaluation" id="npoEvaluation" class="form-control npoEvaluation" placeholder="Informe a Notas Anteriores" type="number" step="0.01" min="0" max="10.00" disabled value="{{ old('npoEvaluation') ?? $project->npo_evaluation}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="projectStrategy" class="form-control" placeholder="Descreva como será executada a estratégia do lançamento" aria-label="Informações adicionais:">{{ old('projectStrategy') ?? $project->cp_strategy}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="productAggregates" class="form-control" placeholder="Descreva todos os produtos e bônus que serão ofertados no lançamento" aria-label="Os agregados do produto principal">{{ old('productAggregates') ?? $project->cp_aggregates}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="offersDescription" class="form-control" placeholder="Descreva quais e como a ofertas serão utilizadas" aria-label="Ofertas do Lançamento">{{ old('offersDescription') ?? $project->cp_offers_description}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="projectStructure" class="form-control" placeholder="Descreva a Estrutura técnica do lançamento" aria-label="Estrutura técnica do lançamento">{{ old('projectStructure') ?? $project->cp_structure}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="projectLinks" class="form-control" placeholder="Informe todos os links do lançamento." aria-label="Todos os links do lançamento">{{ old('projectLinks') ?? $project->cp_links}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="projectDefinitions" class="form-control" placeholder="Informe as definições do lançamento." aria-label="Definições do lançamento">{{ old('projectDefinitions') ?? $project->cp_definitions}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea name="projectAdsCopy" class="form-control" placeholder="Escreva aqui os Textos dos anúncios do lançamento." aria-label="Textos dos anúncios do lançamento">{{ old('projectAdsCopy') ?? $project->cp_ads_copy}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
