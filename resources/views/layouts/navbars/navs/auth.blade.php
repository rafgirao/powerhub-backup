    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="navbar-search {{ $searchClass ?? 'navbar-search-light' }} form-inline mr-sm-3" id="navbar-search-main">
                <div class="form-group mb-0">
                    <div class="input-group input-group-alternative input-group-merge">
                        ...
                        <input class="form-control" placeholder="{{ __('Procurar') }}" type="text">
                    </div>
                </div>
            ...
            <ul class="navbar-nav align-items-center ml-md-auto">
                ...
                <li>
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle focus:outline-none" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            {{ session()->get('account')->company}} ({{session()->get('account')->id}})
                        </button>
                        <div class="dropdown-menu focus:outline-none" aria-labelledby="dropdownMenuButton">
                            @foreach(session()->get('accounts') as $account)
                                <form method="post" action="{{ route('home.show')}}" autocomplete="off">
                                    @csrf
                                    <input class="" form-control="" type="hidden" id="account-{{$account->id}}" name="account" value="{{$account->id}}" required>
                                    <button type="submit" class="dropdown-item hover:bg-indigo-600">{{$account->company}} ({{$account->id}})</button>
                                </form>
                            @endforeach
                        </div>
                    </div>
...
{{--                </li>--}}
            ...
            <ul wire:ignore.self class="navbar-nav align-items-center ml-auto ml-md-0">
                <li class="nav-item dropdown">
